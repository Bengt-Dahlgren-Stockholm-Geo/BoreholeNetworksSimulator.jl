...
For users interested in running BoreholeNetworksSimulatorFork.jl from Python, see also [Running BoreholeNetworksSimulatorFork from Python](@ref).

# Design philosophy

The driving motivation when developing BoreholeNetworksSimulatorFork.jl was to create an easy to use tool that is also highly flexible and performant.
